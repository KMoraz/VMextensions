...
param(
	...
	[String] $AzureCredentialName = "Default Automation Credential",
    [parameter(Mandatory=$false)]
...
try
{
    ...
    if($AzureCredentialName -eq "Use *Default Automation Credential* asset")
    {
        ...
        $azureCredential = Get-AzureAutomationCredential -AutomationAccountName "Default Automation Credential"
    ...
    else
    {
        ...
        $azureCredential = Get-AzureAutomationCredential -AutomationAccountName $AzureCredentialName
